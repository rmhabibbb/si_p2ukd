...
<div class="container-xl px-4 mt-n10">
    <div class="card mb-4">
        <div class="card-body">
            ...
            <button type="button" data-bs-toggle="modal" data-bs-target="#pdf" class="btn btn-success">Download Laporan</button>
...
<div class="modal fade" id="pdf" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('petugas/downloadpdf') ?>" method="Post">
                    ...
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <th>
                                <div class="row">
                                    <div class="col-6">
                                        <select class="form-control" name="bulan_start" required>
                                            <option value="">Pilih Bulan</option>
                                            <option value="1">Januari</option>
                                            <option value="2">Februari</option>
                                            <option value="3">Maret</option>
                                    ...
                                    <div class="col-6">
                                        <input type="number" class="form-control" name="tahun_start" value="<?= date('Y') ?>" required autofocus>
                                    </div>
                                </div>
                            </th>
                        </tr>
                        ...
                        <tr>
                            ...
                            <th>
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <input type="number" class="form-control" name="tahun_end" value="<?= date('Y') ?>" required autofocus>
                                    </div>
                                </div>
                            </th>
                        </tr>
            ...
            <div class="modal-footer">
                <input type="submit" class="btn bg-success text-white" target="_blank" name="tambah" value="Download">
            </div>
