                ...
                <footer class="footer-admin mt-auto footer-light">
                    <div class="container-xl px-4">
                        <div class="row">
                            <div class="col-md-6 small">Copyright &copy; P2UKD 2022</div>
                    ...
                    $(document).ready(function() {
                        $("#editform2").change(function() {
                            ...
                            $.ajax({
                                ...
                                url: "<?php echo base_url(); ?>operator/cekpasslama",
                                method: "post",
                                data: {
                                    pass
                                },
                            ...
                            $.ajax({
                                ...
                                url: "<?php echo base_url(); ?>operator/cekpass",
                                method: "post",
                                data: {
                                    pass1: pass1
                                },
                            ...
                            $.ajax({
                                ...
                                url: "<?php echo base_url(); ?>operator/cekpass2",
                                method: "post",
                                data: {
                                    pass1: pass1,
                                    pass2: pass2
